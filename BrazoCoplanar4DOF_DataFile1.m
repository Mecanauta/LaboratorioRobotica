...
smiData.RigidTransform(1).translation = [64.000000000000028 1.1102230246251565e-13 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [63.999999999999957 149.97634602523206 -0.021695502790464616];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(3).translation = [74.000000000000043 149.97634602523215 -0.021695502790436416];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [72.000000000000028 2.8473502139478274e-14 -1.4210854715202004e-14];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [83 58.000000000000021 0];  % mm
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(6).translation = [-50.000000000000071 -6.3948846218409017e-14 -7.1054273576010019e-15];  % mm
smiData.RigidTransform(6).angle = 2.0943951023931957;  % rad
smiData.RigidTransform(6).axis = [0.57735026918962595 0.57735026918962584 0.57735026918962551];
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(8).translation = [1.5965217080960851e-12 -29.000000000000014 1.0155094900019561e-12];  % mm
...
smiData.RevoluteJoint(2).Rz.Pos = -89.999999999999972;  % deg
...
smiData.RevoluteJoint(4).Rz.Pos = 90.275756749150048;  % deg
