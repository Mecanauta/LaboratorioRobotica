...
smiData.RigidTransform(4).axis = [-9.7019137802231701e-18 1 4.1569267489688521e-17];
...
smiData.RigidTransform(6).axis = [1.5700924586837749e-16 1 -0];
...
smiData.RevoluteJoint(1).Rz.Pos = 87.177519666011392;  % deg
smiData.RevoluteJoint(1).ID = "[Base-1:-:Base de eslabon 1-1]";
